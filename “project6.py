# -*- coding: utf-8 -*-
"""“Project 6 Student.ipynb”的副本

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LZbBxvo-nrgXF48ofVIIMKB2CpMY0G6T

# Project 6: Iterative Closest Point

Due Date: Monday, April 20, 2020 @ 11:59 P.M.

Student Name: Wanli Qian
...
def transform_cloud(bTa, clouda):
    ...
    """
    transform = np.vstack((clouda, np.ones((1, clouda.shape[1]))))
    return (bTa.matrix() @ transform)[:-1,:]
...
def assign_closest_pairs(clouda, cloudb):
    ...
    """
    neighbor = NearestNeighbors(1)
    b = np.swapaxes(cloudb, 0, 1)
    neighbor.fit(b)
    a = np.swapaxes(clouda, 0, 1)
    pts = neighbor.kneighbors(a)[1].flatten()
    return np.swapaxes(b[pts], 0, 1)
